...
#define EIC7700_DIV(_id, _name, _pname, _flags, _offset, _shift,	\
...
#define EIC7700_GATE(_id, _name, _pname, _flags, _offset, _idx,		\
		     _gflags)						\
	{								\
		.id		= _id,					\
		.name		= _name,				\
...
#define EIC7700_MUX_TBL(_id, _name, _pnames, _num_parents, _flags,	\
